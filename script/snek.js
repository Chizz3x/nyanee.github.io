...
function loadScreen() {
  ...
  filter.src = './images/whitenoise.png';
...
function start() {
  ...
  holder.style['background-color'] = 'rgba(10,10,10,0.2)';
  ...
  elements.close.src = './images/close.png'
  ...
  elements.helperImage.src = './images/controls.png'
  ...
  gameArea = {
    ...
    start: function() {
      ...
      for(let i = 0; i < partsNames.length; i++) {
        ...
        part.src = `./images/${partsNames[i]}.png`;
      ...
      for(let i = 0; i < partsFood.length; i++) {
        part = document.createElement('img');
        part.classList.add('sprite');
        part.src = `./images/${partsFood[i]}.png`;
        holder.appendChild(part);
